# AWESOME DOCUMENTATION OF PROJECT 17: INFRASTRUCTURE AUTOMATION WITH IAC USING TERRAFORM

[Link to Terraform Implementation](https://github.com/miraclemoses/TCS-Terraform)
...
resource "aws_sns_topic" "miracle-sns" {
  name = "Default_CloudWatch_Alarms_Topic"
}

# creating notification for all the auto scaling groups

resource "aws_autoscaling_notification" "miracle_notifications" {
  group_names = [
  ...
  topic_arn = aws_sns_topic.miracle-sns.arn
}
...
sudo git clone https://github.com/miraclemoses/TCS-Project-Configuration.git
...
systemctl start php-fpm
systemctl enable php-fpm
git clone https://github.com/miraclemoses/tooling.git
mkdir /var/www/html
